...
if(isset($parameters)){
	...
	if(JSONCorrecto($mensajeRecibido)){
		...
		$cantante = $mensajeRecibido["actualizarCantante"]; 
		...
		$query  = "UPDATE cantante SET nombre = '$nombre', fechaNac = '$fecha', nacionalidad = '$nacionalidad', genero = $genero WHERE ID $id;";
		...
		if (isset ( $result ) && $result) {
			...
			$arrMensaje["mensaje"] = "Cantante actualizado correctamente";
